...
(function () {
  ...
  function renderMain() {
    app.innerHTML =
      '<h1>YBH幸运摇人器</h1>' +
      '<div class="sub">智能抽人 · 不重复模式 · 屏蔽 · 连抽 · 语音播报 · 26H2 Build 13</div>' +
      '<div class="banner">' +
  ...
  if (typeof window !== 'undefined') window.LuckyPicker = { Core: Core, TTS: TTS, Sha256: Sha256, version: '26H2 Build 13', showBallAgain: showBallAgain };
